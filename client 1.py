...
sock = socket.socket()
host = " 10.182.179.221" #Enter local ip of your computer.
port = 8080
...
fpath = "G:\\Distributed Systems\\multithreading\\client1\\" # $$$ Enter the path to the client1 folder present on your computer $$$.
